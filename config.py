...
WEBEX_TEAMS_AUTH = 'Bearer ' + 'Paste your Webex Token here'
WEBEX_TEAMS_ROOM = 'Your Space Name'

WEBHOOK_URL = 'https://zapodeanu.pythonanywhere.com/webhook'
WEBHOOK_USERNAME = 'admin'
WEBHOOK_PASSWORD = 'password'

DNAC_URL = 'DNAC url'

SDWAN_URL = 'SDWAN URL:8443'

PAGERDUTY_INTEGRATION_KEY = 'Pager Duty Integration Key'
